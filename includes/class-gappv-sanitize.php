...
class Gappv_Sanitize {
    ...
    public function clean() {
         ...
         */
        do_action( 'gappv_pre_sanitize', $sanitized );
        ...
        switch ( $this->type ) {
            ...
            case 'password'				: $sanitized = sanitize_text_field( $this->data ); break;
         ...
         */
        do_action( 'gappv_post_sanitize', $sanitized );
    ...
    public function set_type( $type ) {
        ...
        if ( empty( $type ) ) {
            ...
            $check = new WP_Error( 'forgot_type', __( 'Specify the data type to sanitize.', 'gappv' ) );

        }

        if ( is_wp_error( $check ) ) {

            wp_die( $check->get_error_message(), __( 'Forgot data type', 'gappv' ) );
